...
void test_exec_2()
{
    ...
    if (pid) {
        ...
        Instruction i0 = { MOVI,    0, 5 };
        Instruction i1 = { MOV,     1, 0 };
        Instruction i2 = { ADDI,    1, 1, -1};
        Instruction i3 = { BEQI,    6, 1, 1};
        Instruction i4 = { MUL,     0, 0, 1};
        Instruction i5 = { B,       2 };
        Instruction i6 = { HALT };
        Instruction iX = { B,    0 };
        ...
        for (size_t i = 0; i < program_2.size; i++) {
            ...
            assert(inst_1->code == inst_2->code && "Received opcode does not match");
            assert(inst_1->dest == inst_2->dest && "Received dest does not match");
            assert(inst_1->arg1 == inst_2->arg1 && "Received arg1 does not match");
            assert(inst_1->arg2 == inst_2->arg2 && "Received arg2 does not match");
        }
